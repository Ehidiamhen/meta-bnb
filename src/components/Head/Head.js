...
export default function Head () {
    return (
        <header>
            <div className="flex max-md:flex-wrap px-3 pl-4 py-28">
            <div className="w-7/12 max-md:w-11/12 max-md:items-center text-left pl-14">
              ...
              <form className="pt-12">
                <input type='text' size='40' placeholder="Search for a location" className="font-normal max-md:w-7/12 text-sm border border-[#A3A3A3] focus:outline-none rounded-l-lg bg-[rgba(247, 247, 247, 0.1);] py-4 px-4"></input>
